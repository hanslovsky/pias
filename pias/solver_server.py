...
_INTEGER_PATTERN = 'f%s{_ENDIANNESS}'
...
class SolverServer(object):
    ...
    def __init__(
        ...
        # solution_request_socket        = ReplySocket('%s-get-solution' % address_base, timeout=10, respond=current_solution)
        ...
        self.server  = Server(ping_socket)
